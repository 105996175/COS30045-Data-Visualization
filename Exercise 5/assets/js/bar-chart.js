const drawBarChart = data => {
    ...
    innerChart
        ...
        .attr(
            "x",
            d => xScale(d.Screen_Tech)
        )
        .attr(
            "y",
            d => yScale(d.Energy_Consumption)
        )
        .attr("fill", "green");
    ...
    innerChart
        ...
        .text(
            d => `${Math.round(d.Energy_Consumption)} kWh`
        )
        .attr(
            "x",
            d => xScale(d.Screen_Tech) +
        ...
        .attr(
            "y",
            d => yScale(d.Energy_Consumption) - 8
        )
...
d3.csv(
    ...
    // Sort highest energy consumption to lowest
    data.sort(
        (a, b) =>
